...
1. Modify paths in [coco_detection.yml](./configs/dataset/coco_detection.yml)
    ...
    ```yaml
    train_dataloader:
        img_folder: ../datasets/COCO2017/train2017/
        ann_file: ../datasets/COCO2017/annotations/instances_train2017.json
    val_dataloader:
        img_folder: ../datasets/COCO2017/val2017/
...
4. **Update Configuration Files:**
    ...
    train_dataloader:
      ...
      dataset:
        type: CocoDetection
        img_folder: ../datasets/yourdataset/train
        ann_file: ../datasets/yourdataset/train/train.json
        return_masks: False
        transforms:
          type: Compose
          ops: ~
    ...
    val_dataloader:
      ...
      dataset:
        type: CocoDetection
        img_folder: ../datasets/yourdataset/val
        ann_file: ../datasets/yourdataset/val/ann.json
        return_masks: False
        transforms:
          type: Compose
          ops: ~
